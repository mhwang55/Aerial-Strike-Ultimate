...
public class Framework extends Canvas {
     ...
     */
    public static enum GameState{STARTING, VISUALIZING, GAME_CONTENT_LOADING, MAIN_MENU, CHARACTER_SELECTION,
    ...
    // character selection before game
    ...
    private void LoadContent()
    {
        try 
        {
            URL menuBorderImgUrl = this.getClass().getResource("resources/old/images/menu_border.png");
            ...
            URL gameTitleImgUrl = this.getClass().getResource("resources/old/images/helicopter_battle_title.png");
            gameTitleImg = ImageIO.read(gameTitleImgUrl);
            
            URL cloudLayer1ImgUrl = this.getClass().getResource("resources/old/images/cloud_layer_1.png");
            cloudLayer1Img = ImageIO.read(cloudLayer1ImgUrl);
            URL cloudLayer2ImgUrl = this.getClass().getResource("resources/old/images/cloud_layer_2.png");
        ...
        while(true)
        {
            ...
            switch (gameState)
            {
                ...
                case CHARACTER_SELECTION:
                    //...
                    time++;
                    type = characterSelection.updateSelection();
                    break;
                case OPTIONS:
                    //...
                break;
                ...
                break;
                case VISUALIZING:
                    // On Ubuntu OS (when I tested on my old computer) this.getWidth() method doesn't return the
                    // correct value immediately (eg. for frame that should be 800px width, returns 0 than 790 and at last 798px).
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            case CHARACTER_SELECTION:
                //
                characterSelection.draw(g2d, time);
                break;
            case PLAYING:
    ...
    /**
     * Starts new character selection.
     */
    ...
    public void keyReleasedFramework(KeyEvent e)
    {
        ...
        switch(gameState)
        {
            ...
            case MAIN_MENU:
                characterSelection();
            case CHARACTER_SELECTION:
                if(e.getKeyCode() == KeyEvent.VK_J || e.getKeyCode() == KeyEvent.VK_ENTER)
                    newGame();
            break;
        }
    }
