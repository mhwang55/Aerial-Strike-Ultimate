...
public class BulletMedium extends Bullet{
    ...
    public BulletMedium(int xCoordinate, int yCoordinate, double angle, double angleAdd, double speed, double accel)
    {
        super(xCoordinate, yCoordinate, angle, angleAdd, speed, bulletImg, 1, 10, accel);
