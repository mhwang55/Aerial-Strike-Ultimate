...
public class AmbulatamuereBody extends Drawable {
    ...
    public AmbulatamuereBody(int xCoordinate, int yCoordinate, BufferedImage enemyImg, int frameWidth, int frameHeight, int noFrames)
    {
