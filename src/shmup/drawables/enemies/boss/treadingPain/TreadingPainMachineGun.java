...
public class TreadingPainMachineGun extends Turret {
    ...
    public TreadingPainMachineGun(int xCoordinate, int yCoordinate, BufferedImage enemyImg,
                                  int frameWidth, int frameHeight, int noFrames, int gunNo, long gameTime)
    {
        ...
        {
            Logger.getLogger(TreadingPainMachineGun.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
